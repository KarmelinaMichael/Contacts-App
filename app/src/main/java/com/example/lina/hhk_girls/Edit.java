...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mobile1=(EditText) findViewById(R.id.mobile1E);
        mobile2=(EditText) findViewById(R.id.mobile2E);
        home1=(EditText) findViewById(R.id.home1E);
        home2=(EditText) findViewById(R.id.home2E);
...
*/
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            dbHandler.update(Integer.parseInt(ids[0]),name.getText().toString(),year.getText().toString(),mobile1.getText().toString(),
